...
(defvar custom-versions-load-alist '(("19.29" time-stamp) ("20" ebnf2ps ps-print) ("20.1" time-stamp) ("20.3" avoid which-func xscheme ffap add-log compile rmail uce hexl vcursor browse-url dabbrev cus-edit paren msb find-func sendmail debug diary-lib) ("20.3.3" dos-vars) ("20.4" sh-script hilit-chg compile) ("20.8" sql) ("21.1" dabbrev rmailedit latin1-disp ezimage smtpmail gnus-start hideshow strokes sb-image vc-sccs net-utils browse-url debug fortran cperl-mode cal-hebrew sgml-mode server gnus-group vc-cvs vc rmail gnus-sum sendmail gnus-agent cus-edit paren find-func vc-rcs nnmail add-log ps-print etags flyspell gnus-art ange-ftp wid-edit message) ("21.3" gnus-agent ange-ftp sql) ("22" ps-print ebnf2ps) ("22.1" allout imenu binhex tcl imap sh-script gnus-srvr spam sgml-mode mail-source generic-x gnus-int dabbrev mm-view locate fortran glasses sql gnus-win view vc-svn mm-uu descr-text ielm ffap vc gnus-score diary-lib rmail gnus-group mml2015 ispell make-mode gnus-msg shadowfile x-dnd bookmark uudecode mm-util cal-tex compare-w mml find-func tls autorevert mml-sec add-log info hl-line dired smime flow-fill mail-extr ange-ftp desktop starttls diff-mode mm-url pop3 time cal-dst sendmail gnus-fun comint mm-decode grep gnus-agent latin1-disp vc-cvs nnmail gnus-delay warnings gnus-cite gnus-art server deuglify gdb-mi cus-edit hi-lock tex-mode gnus-sum compile message keypad gnus gnus-util calendar gnus-start) ("22.2" sql gdb-mi tls vc-mtn gnus-sum css-mode bibtex-style dired desktop vc-hg find-dired mail-source) ("22.3" message) ("23.1" descr-text fortune gdb-mi smiley server imap nnmail gnus-draft gnus-util gnus-dired copyright cus-edit mm-decode mml checkdoc dired-aux smime rmailmm gnus-bookmark view icomplete vc-git misearch pcmpl-unix info f90 compile gnus-msg filesets rmail gnus gnus-group informat allout spam-report vc-cvs vc-mtn gnus-score bibtex sendmail mm-uu tls hideif face-remap fortran ffap holidays message gnus-art gnus-sum time browse-url tex-mode nnmairix vc-hg pop3 woman calendar) ("23.2" diary-lib tramp-gvfs rmailmm gnus-sum help-fns ansi-color bytecomp gnus-group mm-encode rmail calendar lunar dired elint message comint auth-source desktop doc-view gdb-mi) ("23.3" desktop rmailsum calendar rmail diary-lib) ("23.4" ede) ("24.1" org-timer em-ls esh-cmd package-x esh-io org-src cc-vars em-smart esh-proc em-prompt ob-R ob-picolisp esh-arg ob-plantuml org-gnus org-crypt vc-cvs em-term log-edit em-hist erc-button copyright f90 erc-backend esh-mode em-cmpl woman etags dirtrack em-pred gnus-msg ob-lisp org-attach em-unix dired-x cc-fonts em-banner hl-line man ibuffer cus-theme esh-ext sieve-manage em-script gnus-registry gnus-srvr ob-lob ido auth-source battery emacs-lock gssapi netrc gnus-art ange-ftp find-dired doc-view smtpmail ob-exp em-dirs mm-decode flyspell mml vc-svn js org-mobile calendar vc-bzr gnus-group vc-rcs em-alias erc-join gnus-picon elec-pair glasses message em-rebind esh-var mml2015 shr vc gnus-html ob-tangle diary-lib calc org-habit saveplace compile org-capture url-cache image-mode ses esh-util allout gnus-sum org-ctags sendmail pcmpl-unix tramp org-entities org-clock info org-inlinetask arc-mode url-queue nnir ob-ditaa ob-core sql appt vc-sccs server ox-icalendar rcirc cl-indent gnus-async rmail smiley package cc-guess gnus-util org-archive browse-url org-table em-glob gnus cus-edit allout-widgets ob-js gnus-gravatar org-faces bibtex vc-git ox-odt gnus-int org-agenda pop3 org-list verilog-mode prolog org gnus-start feedmail mm-view org-bibtex rst) ("24.2" which-func) ("24.3" ediff-wind perl-mode em-term proced ffap org-id rcirc message erc-backend ido calendar server tramp ox-odt avoid which-func wdired executable bug-reference calc pcmpl-gnu ox pcmpl-rpm icalendar gnus-picon sh-script org-capture cal-html vhdl-mode hexl diff-mode minibuf-eldef gdb-mi flymake debug tramp-smb cus-edit erc-match org-agenda gnus-msg sql smerge-mode allout apropos reftex-vars verilog-mode semantic/complete nnmail compile org emacs-lock org-datetree man) ("24.4" ob-core bibtex em-term mml2015 tramp-cache gdb-mi message epa recentf gnus-start f90 tramp-adb strokes calc timeclock man info autorevert imenu idlwave sql org-faces org-gnus term ede/linux tramp-smb cookie1 org-protocol dired ansi-color tramp-sh mm-util cfengine saveplace vhdl-mode org-archive sh-script rlogin hi-lock org-clock nnimap sieve-manage gnus-art ox-beamer verilog-mode js rmail org-src apropos info-xref flymake type-break ob-ruby m4-mode bookmark ox flyspell log-edit ox-texinfo unrmail org-attach ange-ftp smie gnus mml-smime ob-ocaml gnutls reftex-vars org-mobile pop3 shr pcmpl-x desktop ob-ditaa quickurl python eww org gnus-sum compare-w ox-man ob-python icomplete vc-svn ox-html remember calendar tramp octave doc-view org-agenda ox-odt ox-latex elec-pair package find-file ido ruby-mode ox-ascii) ("24.5" flyspell vc-hg erc-stamp erc mml2015) ("25.1" checkdoc js rcirc sh-script info vc-cvs url-tramp arc-mode em-term sgml-mode message vhdl-mode sql mml-sec ldap filecache vc-svn gnus-sum newst-reader vc gud autoinsert gnus-art rmailmm newst-treeview hideif find-func mm-decode cl-indent vc-hg eudc-vars gnus-fun gnus-registry calendar epg-config erc nsm gdb-mi erc-desktop-notifications url-handlers python check-declare xt-mouse whitespace compare-w tildify vc-mtn net-utils epa vc-bzr rect eww paren tramp-adb diff-mode shr verilog-mode tex-mode icalendar browse-url vc-git package vc-annotate) ("25.2" tramp-sh ffap) ("26.1" js css-mode package sql flyspell battery mhtml-mode cpp browse-url ibuffer grep ibuf-ext dired dunnet bibtex sieve-manage erc tramp-sh wdired tramp message ediff-init add-log comint gnus-mh shr image-dired net-utils gnus-art vc-git url-vars dired-x tramp-gvfs edebug vc-hg))
